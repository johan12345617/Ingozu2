...
public class ImagenCompleta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            urlFoto=bundle.getString("imagenPath");
        }

        ActionBar actionBar = getSupportActionBar();
        setContentView(R.layout.activity_imagen_completa);
        PhotoView fotoCaja= findViewById(R.id.fullscreen_content);
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(android.R.color.black)));
        actionBar.setTitle("Titulo gozu");
        Glide.with(this).load(urlFoto).into(fotoCaja);
        mVisible = true;
